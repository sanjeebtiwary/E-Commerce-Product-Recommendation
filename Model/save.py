...
def recommend(user_id):
    ...
    def predict_userbased(user_id, item_id, ratings, metric=metric, k=k):
        ...
        similarities, indices = findksimilarusers(user_id, ratings, metric,
                                                  k)  # similar users based on cosine similarity
    ...
    return render_template('recommend.html', lo=loyal, word=str1, word1=str2, name=names, book1=lis, book2=lid,
                           book3=lit, book4=liq, book5=liw, book6=lir, predict4=predict1[0][0], predict5=predict2[0][0],
                           predict6=predict3[0][0], discount1=predict11[0][0], discount2=predict22[0][0],
                           discount3=predict33[0][0])
